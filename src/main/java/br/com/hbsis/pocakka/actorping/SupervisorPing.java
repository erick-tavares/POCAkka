...
public class SupervisorPing extends UntypedAbstractActor {
    ...
    public SupervisorStrategy supervisorStrategy() {
        return new OneForOneStrategy(5, Duration.apply(2, TimeUnit.SECONDS), new Function<Throwable, SupervisorStrategy.Directive>() {
            @Override
            public SupervisorStrategy.Directive apply(Throwable e) throws Exception {
                log.error("Supervisor Strategry error: " + e.getMessage(), e);
...
//    }
    ...
    public void onReceive(Object mensagem) throws Throwable {
        ...
        if (mensagem.equals("Iniciar")) {
            ...
            log.info("EXCEPTION");
            throw new Exception();
            //strategy.restartChild(actorPingBaixoRef,new NullPointerException(), true);
